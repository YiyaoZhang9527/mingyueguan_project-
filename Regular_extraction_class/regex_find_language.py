...
# url https://gist.github.com/terrancesnyder/1345094
...
def regex_find_Japanese_hiragana_char(string):
    ...
    日语 - 平假名
    """
    return re.findall(r"[\u3041-\u3094\u309E\u309B\u309C\u30FC]+", string)
...
def regex_find_Japanese_katakana_char(string):
    ...
    日语 - 片假名
    """
    return re.findall(r"[\u30A1-\u30FB\u30FD\u30FE\u309B\u309C\u30FC]+", string)

def regex_find_Japanese_hiragana_and_katakana_char(string):
    """
    Regular extraction of Japanese.
    日语 - 平假名和片假名
    """
    return re.findall(r"[\u3041-\u3094\u309E\u30A1-\u30FB\u30FD\u30FE\u309B\u309C\u30FC]+", string)
...
def regex_find_Japanese_kanji_char(string):
    ...
    """
    #return re.findall(r"[\u4E00-\u9FA5]+", string)
    return re.findall(r"[一-龯]+", string)
...
def regex_find_Japanese_char(string):
    ...
    日语
    """
    return re.findall(r"[一-龯\u3041-\u3094\u309E\u30A1-\u30FB\u30FD\u30FE\u309B\u309C\u30FC]+", string)

# def regex_find_non_hirgana_char(string):
#     """
#     Regular extraction of non-hirgana.
#     非平假名
#     """
#     return re.findall(r"^[ぁ-んァ-ン]+", string)
...
#     日语 - 片假名 - 后缀
#     """
#     return re.findall(r"[\u3099-\u309E]+", string)
